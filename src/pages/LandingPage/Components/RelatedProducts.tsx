...
const RelatedProducts: React.FC<RelatedProductsProps> = ({
  ...
  const relatedProducts = data?.data?.filter((p) => p._id !== currentProductId).slice(0, 4) || [];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {relatedProducts.map((product: Product) => (
          ...
          >
            ...
            <div className="p-5">
              <div className="text-xs text-gray-500 mb-1 uppercase tracking-wider">{product.basicInfo.category}</div>
