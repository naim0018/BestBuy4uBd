...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Wishlist Button */}
      <button className="absolute top-4 right-4 z-10 w-9 h-9 rounded-full bg-white/80 dark:bg-slate-800/80 backdrop-blur-md shadow-lg flex items-center justify-center text-slate-400 hover:text-primary-red hover:bg-white dark:hover:bg-slate-700 transition-all duration-300 transform hover:scale-110">
